...
export const TAG_COLORS: Record<string, TagColor> = {
  ...
  'Community': { bg: '#EAF0F5', text: '#1D547C', border: '#9DBCD2' },
  'Data Analysis': { bg: '#F5EAED', text: '#7C1D38', border: '#D29DAC' },
  'Data Structures': { bg: '#F5F0EA', text: '#7C501D', border: '#D2B99D' },
  'Data Visualization': { bg: '#EAF5EA', text: '#1D7C1E', border: '#9DD29D' },
  'Docker': { bg: '#EAF5F3', text: '#1B7464', border: '#9DD2C9' },
  'Expo': { bg: '#EDEAF5', text: '#391D7C', border: '#AD9DD2' },
  ...
  'Full-Stack Development': { bg: '#F5F0EA', text: '#7C551D', border: '#D2BC9D' },
  'Go': { bg: '#EAF5ED', text: '#1D7C38', border: '#9DD2AC' },
  'GraphQL': { bg: '#F1EAF5', text: '#541D7C', border: '#BC9DD2' },
  'IndexedDB': { bg: '#EAF5F4', text: '#1D7C71', border: '#9DD2CC' },
  ...
  'Leadership': { bg: '#F5EAF3', text: '#7C1D6C', border: '#D29DC9' },
  ...
  'OAuth': { bg: '#F0F5EA', text: '#4E7A1D', border: '#B9D29D' },
  ...
  'Project Management': { bg: '#EAEDF5', text: '#1D347C', border: '#9DAAD2' },
  'Prototyping': { bg: '#F5F1EA', text: '#7C5C1D', border: '#D2C09D' },
  'Public Speaking': { bg: '#F5EAEA', text: '#7C221D', border: '#D2A09D' },
  'Python': { bg: '#EAF5F4', text: '#1B7470', border: '#9DD2D0' },
  'Research': { bg: '#EAF5EE', text: '#1D7C3D', border: '#9DD2AF' },
...
export const TAG_COLORS_DARK: Record<string, TagColor> = {
  ...
  'Community': { bg: 'rgba(139, 190, 228, 0.15)', text: 'rgb(139, 190, 228)', border: 'rgba(139, 190, 228, 0.35)' },
  'Data Analysis': { bg: 'rgba(228, 139, 165, 0.15)', text: 'rgb(228, 139, 165)', border: 'rgba(228, 139, 165, 0.35)' },
  'Data Structures': { bg: 'rgba(228, 187, 139, 0.15)', text: 'rgb(228, 187, 139)', border: 'rgba(228, 187, 139, 0.35)' },
  'Data Visualization': { bg: 'rgba(139, 228, 140, 0.15)', text: 'rgb(139, 228, 140)', border: 'rgba(139, 228, 140, 0.35)' },
  'Docker': { bg: 'rgba(139, 228, 212, 0.15)', text: 'rgb(139, 228, 212)', border: 'rgba(139, 228, 212, 0.35)' },
  'Expo': { bg: 'rgba(166, 139, 228, 0.15)', text: 'rgb(166, 139, 228)', border: 'rgba(166, 139, 228, 0.35)' },
  ...
  'Full-Stack Development': { bg: 'rgba(228, 192, 139, 0.15)', text: 'rgb(228, 192, 139)', border: 'rgba(228, 192, 139, 0.35)' },
  ...
  'IndexedDB': { bg: 'rgba(139, 228, 217, 0.15)', text: 'rgb(139, 228, 217)', border: 'rgba(139, 228, 217, 0.35)' },
  ...
  'Leadership': { bg: 'rgba(228, 139, 213, 0.15)', text: 'rgb(228, 139, 213)', border: 'rgba(228, 139, 213, 0.35)' },
  ...
  'OAuth': { bg: 'rgba(187, 228, 139, 0.15)', text: 'rgb(187, 228, 139)', border: 'rgba(187, 228, 139, 0.35)' },
  ...
  'Project Management': { bg: 'rgba(139, 161, 228, 0.15)', text: 'rgb(139, 161, 228)', border: 'rgba(139, 161, 228, 0.35)' },
  'Prototyping': { bg: 'rgba(228, 198, 139, 0.15)', text: 'rgb(228, 198, 139)', border: 'rgba(228, 198, 139, 0.35)' },
  'Public Speaking': { bg: 'rgba(228, 144, 139, 0.15)', text: 'rgb(228, 144, 139)', border: 'rgba(228, 144, 139, 0.35)' },
  'Python': { bg: 'rgba(139, 228, 224, 0.15)', text: 'rgb(139, 228, 224)', border: 'rgba(139, 228, 224, 0.35)' },
  'Research': { bg: 'rgba(139, 228, 169, 0.15)', text: 'rgb(139, 228, 169)', border: 'rgba(139, 228, 169, 0.35)' },
...
// The canonical skill list. Once skills live in a String[] column instead of
// the Tag table, this file is the only place a skill name is declared, so the
// palette doubles as the vocabulary: a name here renders in its color, a name
// missing from here renders grey rather than erroring.
//
// There is deliberately no foreign key behind this. Adding a skill means
// typing it into a row's array; scripts/validate-skills.ts reports names that
// have no palette entry, which is a lint-time check rather than a constraint.
export const SKILLS: string[] = Object.keys(TAG_COLORS);
