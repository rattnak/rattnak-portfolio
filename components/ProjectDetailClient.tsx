...
export default function ProjectDetailClient({ project }: Props) {
  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 4rem)' }}>
      <BackLink href="/projects" label="Back to Projects" sticky />
      ...
      <div className="container" style={{ paddingTop: '0', paddingBottom: '4rem', maxWidth: '80rem' }}>
        ...
        <div style={{ marginBottom: '3rem' }}>
          ...
          <h1 className="project-detail-title" style={{ marginBottom: '1rem' }}>
            {project.name}
          </h1>

          <p className="project-detail-description" style={{ marginBottom: (project.type === "CODING" && project.githubUrl) || project.liveUrl || (project.type === "CASE_STUDY" && project.url) ? '1.5rem' : 0 }}>
            {project.description}
          </p>

          {/* Actions */}
          {((project.type === "CODING" && project.githubUrl) || project.liveUrl || (project.type === "CASE_STUDY" && project.url)) && (
