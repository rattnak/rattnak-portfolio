...
export default function AchievementListItem({
  ...
  return (
    <motion.div
      ...
      className="card group competition-list-item"
    >
      ...
      <div className="competition-list-item-content">
        <div className="flex items-center flex-wrap project-card-meta">
          <span className="project-card-meta-type">{type}</span>
          <span className="project-card-meta-separator">•</span>
          <span className="project-card-meta-result">{result}</span>
          {featured && (
            <>
              <span className="project-card-meta-separator">•</span>
        ...
        <h3 style={{
          ...
          <Link href={`/achievements/${id}`} className="stretched-link">
            {name}
          </Link>
        </h3>
